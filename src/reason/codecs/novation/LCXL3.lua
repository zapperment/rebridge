local autoInputs = require "src.lcxl3.config.autoInputs"
...
local deliverDisplay = require "src.lcxl3.remote.deliverMidi.display"
...
local deliverInfo = require "src.lcxl3.remote.deliverMidi.info"
...
local deliverTransport = require "src.lcxl3.remote.deliverMidi.transport"
...
local processEncoders = require "src.lcxl3.remote.processMidi.encoders"
...
local processTransport = require "src.lcxl3.remote.processMidi.transport"
local processRackUI = require "src.lcxl3.remote.processMidi.rackUI"
local processSelection = require "src.lcxl3.remote.processMidi.selection"
...
local setRackUI = require "src.lcxl3.remote.setState.rackUI"
local setInfo = require "src.lcxl3.remote.setState.info"
local setPages = require "src.lcxl3.remote.setState.pages"
local setSelection = require "src.lcxl3.remote.setState.selection"
local setTransport = require "src.lcxl3.remote.setState.transport"
