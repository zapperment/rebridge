return {
  ...
  makeParamNameDisplayEvent = require "src.lib.midi.makeParamNameDisplayEvent",
  makeParamValueDisplayEvent = require "src.lib.midi.makeParamValueDisplayEvent",
  makeSysexEvent = require "src.lib.midi.makeSysexEvent",
}
