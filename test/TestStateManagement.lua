...
function TestStateManagement:testAddAndSubtract()
    ...
    state.add("encoder1.controlSurfaceValue", 20)
    value = state.update("encoder1.controlSurfaceValue")
    errorMessage = "after adding 20 using 'add', 'update' returned an incorrect value"
    lu.assertEquals(value, 20, errorMessage)
    state.add("encoder1.controlSurfaceValue", 20, 0, 30)
    value = state.update("encoder1.controlSurfaceValue")
    errorMessage =
    ...
    state.add("encoder1.controlSurfaceValue", -40, 0, 30)
    value = state.update("encoder1.controlSurfaceValue")
    errorMessage =
