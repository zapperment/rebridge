-- Computes the 7-bit RGB sysex colour values (0-127 integers) for a
-- Launch Control style controller, given a base colour and a 0-127 value.
--
...
local function getColourForValue(hex, value)
  ...
  return to7Bit(nr), to7Bit(ng), to7Bit(nb)
end

if arg and arg[1] and arg[2] then
  local r, g, b = getColourForValue(arg[1], tonumber(arg[2]))
  print(r, g, b)
end